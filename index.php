...
<head>
    ...
    <link rel="icon" type="image/jpeg" href="src/assets/css/logo.jpg">
...
<body class="home-page min-h-screen bg-base-200 p-4 sm:p-6">
    <div class="home-card card mx-auto mt-6 w-full max-w-lg bg-base-100 shadow-2xl">
        <div class="card-body text-center">
            <img src="src/assets/css/logo.jpg" alt="BCNSHS Logo" class="home-logo hoverable-media mx-auto h-24 w-24 rounded-full object-cover">
