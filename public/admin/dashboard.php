...
<table>
    ...
    if ($res && $res->num_rows > 0) {
        while($row = $res->fetch_assoc()){
            ...
            $publicUploadAbs = __DIR__ . "/../assets/uploads/" . $row['photo_path'];
            $legacyUploadAbs = __DIR__ . "/../../assets/uploads/" . $row['photo_path'];
            $photoSrc = "../assets/uploads/" . $photoName;

            if (!file_exists($publicUploadAbs) && file_exists($legacyUploadAbs)) {
                $photoSrc = "../../assets/uploads/" . $photoName;
            }
